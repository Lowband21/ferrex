...
pub enum LibraryMessage {
    ...
    FetchDemoStatus,
    #[cfg(feature = "demo")]
    DemoStatusLoaded(Result<ferrex_player_api::api_types::DemoStatus, String>),
    #[cfg(feature = "demo")]
    ApplyDemoSizing(ferrex_player_api::api_types::DemoResetRequest),
    #[cfg(feature = "demo")]
    DemoSizingApplied(Result<ferrex_player_api::api_types::DemoStatus, String>),
