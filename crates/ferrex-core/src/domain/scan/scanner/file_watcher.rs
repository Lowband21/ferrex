...
//! ---
//!
//! ## Library Registration Flow (replacement for `watch_library`)
//!
...
//! ---
//!
//! ## Flush Loop (replacement for `spawn_watch_loop` + `flush_pending`)
//!
//! Pseudocode outline:
//! ```text
...
//! ---
//!
//! ## Actor Dispatch (replacement for `dispatch_events`)
//!
//! ```text
