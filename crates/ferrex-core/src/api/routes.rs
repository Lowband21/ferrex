...
pub mod v1 {
    ...
    pub mod intelligence {
        ...
        pub const RUN_START: &str = v1_path!("/intelligence/runs");
        pub const RUN_STATUS: &str = v1_path!("/intelligence/runs/{run_id}");
        ...
        pub const DRAFT_ARTIFACT_LIST: &str = v1_path!("/intelligence/drafts");
    ...
    pub mod libraries {
        ...
        pub const RESET: &str = v1_path!("/libraries/{id}/reset");
