...
use crate::database::{
    ...
    repositories::{
        ...
        scan_observability::PostgresScanObservabilityRepository,
    ...
    repository_ports::{
        ...
        scan_observability::ScanObservabilityRepository,
...
impl AppUnitOfWorkBuilder {
    ...
    pub fn with_scan_observability(
        mut self,
        repo: Arc<dyn ScanObservabilityRepository>,
    ) -> Self {
