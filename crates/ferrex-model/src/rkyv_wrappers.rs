...
impl<S: Fallible + ?Sized> SerializeWith<DateTime<Utc>, S> for DateTimeWrapper
where
    i64: Serialize<S>,
{
    fn serialize_with(
    ...
    Archived<i64>: Deserialize<i64, D>,
{
    fn deserialize_with(
        field: &Archived<i64>,
        deserializer: &mut D,
    ) -> Result<DateTime<Utc>, <D as Fallible>::Error> {
...
impl ArchiveWith<Option<DateTime<Utc>>> for OptionDateTime {
...
impl<S: Fallible + ?Sized> SerializeWith<Option<DateTime<Utc>>, S>
    for OptionDateTime
where
...
impl<D: Fallible + ?Sized>
    DeserializeWith<Archived<Option<i64>>, Option<DateTime<Utc>>, D>
    for OptionDateTime
where
    Archived<Option<i64>>: Deserialize<Option<i64>, D>,
{
    fn deserialize_with(
        ...
        deserializer: &mut D,
    ) -> Result<Option<DateTime<Utc>>, <D as Fallible>::Error> {
