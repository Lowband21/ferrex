...
impl PlayerDomainState {
    ...
    fn build_seek_bar(
        ...
        let hit_area_height =
            crate::constants::player_controls::SEEK_BAR_HIT_ZONE_HEIGHT;
        ...
        let played_percentage = if duration > 0.0 {
            (self.last_valid_position / duration).clamp(0.0, 1.0)
        } else {
            log::debug!(
            ...
            row![
                ...
                container(
                    row![
                        ...
                        .height(
                            crate::constants::player_controls::CONTROL_BUTTONS_HEIGHT
                        )
