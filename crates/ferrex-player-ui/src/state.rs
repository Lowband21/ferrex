...
use crate::{
    ...
    infra::{
        ServiceBuilder,
        adapters::AuthManagerAdapter,
        cache::{PlayerDiskImageCache, PlayerDiskImageCacheLimits},
...
use ferrex_player_repository::PlayerDiskMediaRepoCache;
...
impl State {
    ...
    pub fn new_with_interface_mode(
        ...
        let ui_state = UIDomainState {
            ...
            library_maintenance_confirmation: None,
            library_maintenance_in_flight: None,
