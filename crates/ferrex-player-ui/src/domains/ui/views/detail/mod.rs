...
pub use components::{
    ...
    registered_detail_rail_adapters, view_action_cluster,
    view_backdrop_controls, view_cast_band, view_cast_section,
    view_control_shelf, view_detail_hero, view_detail_media_rail_card,
    view_detail_stage, view_detail_stage_with_registered_rails,
    view_empty_stage, view_empty_state, view_fact_panel, view_fact_ribbon,
    view_hero_art, view_metadata_pills, view_metadata_ribbons,
    view_notice_slab, view_overview_section, view_projection_shelf,
    view_registered_cast_band, view_registered_relationship_rail,
    view_registered_relationship_rail_deck, view_relationship_rail,
    view_relationship_rail_deck, view_section, view_sections, view_stage_hero,
    view_stage_section, view_stage_sections, view_technical_ribbon,
