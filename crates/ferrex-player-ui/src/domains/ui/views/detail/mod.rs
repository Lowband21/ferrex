...
//!
//! - [`model`] defines repository-free render data for movies, series, seasons,
//!   episodes, and 10-foot detail surfaces.
//! - [`layout`] resolves a pure viewport/scale/interface-mode plan using the
//!   centralized size provider and scaled layout values.
