...
//! They MUST be kept in sync with `crates/ferrex-player-ui/src/infra/shaders/poster_back.wgsl`.
//!
//! Run `cargo test -p ferrex-player-ui shader_menu_constants_sync` to verify synchronization.
