#!/usr/bin/env bash
# DEPRECATED: This script is deprecated in favor of ferrexctl
# Use: ferrexctl package release-init
#
# This script is kept for backward compatibility during the transition period.
# Please migrate to using ferrexctl for all packaging operations.
