...
impl<'a> SeasonReference<'a> {
    ...
    pub fn id(&self) -> &'a super::ids::Uuid {
        ...
        unsafe {
            self._tab
                .get::<super::ids::Uuid>(SeasonReference::VT_ID, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn library_id(&self) -> &'a super::ids::Uuid {
        ...
        unsafe {
            self._tab
                .get::<super::ids::Uuid>(SeasonReference::VT_LIBRARY_ID, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn season_number(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(SeasonReference::VT_SEASON_NUMBER, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn series_id(&self) -> &'a super::ids::Uuid {
        ...
        unsafe {
            self._tab
                .get::<super::ids::Uuid>(SeasonReference::VT_SERIES_ID, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn tmdb_series_id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(SeasonReference::VT_TMDB_SERIES_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn details(&self) -> Option<super::details::SeasonDetails<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                super::details::SeasonDetails,
            >>(SeasonReference::VT_DETAILS, None)
        }
    }
    #[inline]
    ...
    pub fn discovered_at(&self) -> Option<&'a super::common::Timestamp> {
        ...
        unsafe {
            self._tab.get::<super::common::Timestamp>(
                SeasonReference::VT_DISCOVERED_AT,
                None,
            )
        }
    }
    ...
    pub fn theme_color(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                SeasonReference::VT_THEME_COLOR,
                None,
            )
        }
    }
...
pub struct SeasonReferenceArgs<'a> {
    ...
    pub details:
        Option<::flatbuffers::WIPOffset<super::details::SeasonDetails<'a>>>,
    ...
    SeasonReferenceBuilder<'a, 'b, A>
{
    ...
    pub fn add_season_number(&mut self, season_number: u16) {
        self.fbb_.push_slot::<u16>(
            SeasonReference::VT_SEASON_NUMBER,
            season_number,
            0,
        );
    }
    ...
    pub fn add_tmdb_series_id(&mut self, tmdb_series_id: u64) {
        self.fbb_.push_slot::<u64>(
            SeasonReference::VT_TMDB_SERIES_ID,
            tmdb_series_id,
            0,
        );
    }
    ...
    pub fn add_details(
        &mut self,
        details: ::flatbuffers::WIPOffset<super::details::SeasonDetails<'b>>,
    ) {
    ...
    pub fn finish(self) -> ::flatbuffers::WIPOffset<SeasonReference<'a>> {
        ...
        self.fbb_
            .required(o, SeasonReference::VT_LIBRARY_ID, "library_id");
        self.fbb_
            .required(o, SeasonReference::VT_SERIES_ID, "series_id");
