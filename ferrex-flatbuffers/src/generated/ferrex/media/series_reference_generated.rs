...
impl<'a> SeriesReference<'a> {
    ...
    pub fn id(&self) -> &'a super::ids::Uuid {
        ...
        unsafe {
            self._tab
                .get::<super::ids::Uuid>(SeriesReference::VT_ID, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn library_id(&self) -> &'a super::ids::Uuid {
        ...
        unsafe {
            self._tab
                .get::<super::ids::Uuid>(SeriesReference::VT_LIBRARY_ID, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn tmdb_id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(SeriesReference::VT_TMDB_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn details(&self) -> Option<super::details::EnhancedSeriesDetails<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                super::details::EnhancedSeriesDetails,
            >>(SeriesReference::VT_DETAILS, None)
        }
    }
    #[inline]
    ...
    pub fn discovered_at(&self) -> Option<&'a super::common::Timestamp> {
        ...
        unsafe {
            self._tab.get::<super::common::Timestamp>(
                SeriesReference::VT_DISCOVERED_AT,
                None,
            )
        }
    }
    ...
    pub fn theme_color(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                SeriesReference::VT_THEME_COLOR,
                None,
            )
        }
    }
...
pub struct SeriesReferenceArgs<'a> {
    ...
    pub details: Option<
        ::flatbuffers::WIPOffset<super::details::EnhancedSeriesDetails<'a>>,
    >,
    ...
    SeriesReferenceBuilder<'a, 'b, A>
{
    ...
    pub fn add_tmdb_id(&mut self, tmdb_id: u64) {
        self.fbb_
            .push_slot::<u64>(SeriesReference::VT_TMDB_ID, tmdb_id, 0);
    }
    #[inline]
    ...
    pub fn add_details(
        ...
        details: ::flatbuffers::WIPOffset<
            super::details::EnhancedSeriesDetails<'b>,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<
            super::details::EnhancedSeriesDetails,
        >>(SeriesReference::VT_DETAILS, details);
    }
    #[inline]
    pub fn add_endpoint(
        &mut self,
    ...
    pub fn finish(self) -> ::flatbuffers::WIPOffset<SeriesReference<'a>> {
        ...
        self.fbb_
            .required(o, SeriesReference::VT_LIBRARY_ID, "library_id");
