...
impl<'a> EnhancedSeriesDetails<'a> {
    ...
    >(
        ...
        if let Some(x) = args.episode_groups {
            builder.add_episode_groups(x);
        }
        ...
        if let Some(x) = args.origin_countries {
            builder.add_origin_countries(x);
        }
        if let Some(x) = args.networks {
            builder.add_networks(x);
        }
        ...
        if let Some(x) = args.last_air_date {
            builder.add_last_air_date(x);
        }
        if let Some(x) = args.first_air_date {
            builder.add_first_air_date(x);
        }
    ...
    pub fn id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(EnhancedSeriesDetails::VT_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn original_name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_ORIGINAL_NAME,
                None,
            )
        }
    }
    ...
    pub fn overview(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_OVERVIEW,
                None,
            )
        }
    }
    ...
    pub fn first_air_date(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_FIRST_AIR_DATE,
                None,
            )
        }
    }
    ...
    pub fn last_air_date(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_LAST_AIR_DATE,
                None,
            )
        }
    }
    ...
    pub fn number_of_seasons(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(
                    EnhancedSeriesDetails::VT_NUMBER_OF_SEASONS,
                    Some(0),
                )
                .unwrap()
        }
    ...
    pub fn number_of_episodes(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(
                    EnhancedSeriesDetails::VT_NUMBER_OF_EPISODES,
                    Some(0),
                )
                .unwrap()
        }
    ...
    pub fn available_seasons(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(
                    EnhancedSeriesDetails::VT_AVAILABLE_SEASONS,
                    Some(0),
                )
                .unwrap()
        }
    ...
    pub fn available_episodes(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(
                    EnhancedSeriesDetails::VT_AVAILABLE_EPISODES,
                    Some(0),
                )
                .unwrap()
        }
    ...
    pub fn vote_average(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(EnhancedSeriesDetails::VT_VOTE_AVERAGE, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn vote_count(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(EnhancedSeriesDetails::VT_VOTE_COUNT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn popularity(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(EnhancedSeriesDetails::VT_POPULARITY, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn content_rating(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_CONTENT_RATING,
                None,
            )
        }
    }
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                EnhancedSeriesDetails::VT_CONTENT_RATINGS, None
            )
        }
    }
    #[inline]
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                EnhancedSeriesDetails::VT_RELEASE_DATES, None
            )
        }
    }
    #[inline]
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(EnhancedSeriesDetails::VT_GENRES, None)
        }
    }
    #[inline]
    pub fn networks(
        ...
        ::flatbuffers::Vector<
            'a,
            ::flatbuffers::ForwardsUOffset<NetworkInfo<'a>>,
        >,
    > {
        // Safety:
        // Created from valid Table for this object
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<NetworkInfo>,
                >,
            >>(EnhancedSeriesDetails::VT_NETWORKS, None)
        }
    }
    #[inline]
    pub fn origin_countries(
        &self,
    ) -> Option<
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                EnhancedSeriesDetails::VT_ORIGIN_COUNTRIES, None
            )
        }
    }
    #[inline]
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                EnhancedSeriesDetails::VT_SPOKEN_LANGUAGES, None
            )
        }
    }
    #[inline]
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                EnhancedSeriesDetails::VT_PRODUCTION_COMPANIES, None
            )
        }
    }
    #[inline]
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                EnhancedSeriesDetails::VT_PRODUCTION_COUNTRIES, None
            )
        }
    }
    #[inline]
    pub fn homepage(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_HOMEPAGE,
                None,
            )
        }
    }
    ...
    pub fn status(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_STATUS,
                None,
            )
        }
    }
    ...
    pub fn tagline(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_TAGLINE,
                None,
            )
        }
    }
    ...
    pub fn in_production(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(
                    EnhancedSeriesDetails::VT_IN_PRODUCTION,
                    Some(false),
                )
                .unwrap()
        }
    ...
    pub fn poster_path(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_POSTER_PATH,
                None,
            )
        }
    }
    ...
    pub fn backdrop_path(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_BACKDROP_PATH,
                None,
            )
        }
    }
    ...
    pub fn logo_path(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                EnhancedSeriesDetails::VT_LOGO_PATH,
                None,
            )
        }
    }
    ...
    pub fn primary_poster_iid(&self) -> Option<&'a super::ids::Uuid> {
        ...
        unsafe {
            self._tab.get::<super::ids::Uuid>(
                EnhancedSeriesDetails::VT_PRIMARY_POSTER_IID,
                None,
            )
        }
    }
    ...
    pub fn primary_backdrop_iid(&self) -> Option<&'a super::ids::Uuid> {
        ...
        unsafe {
            self._tab.get::<super::ids::Uuid>(
                EnhancedSeriesDetails::VT_PRIMARY_BACKDROP_IID,
                None,
            )
        }
    }
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<MediaImages>>(
                    EnhancedSeriesDetails::VT_IMAGES,
                    None,
                )
        }
    }
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(EnhancedSeriesDetails::VT_CAST, None)
        }
    }
    #[inline]
    pub fn crew(
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(EnhancedSeriesDetails::VT_CREW, None)
        }
    }
    #[inline]
    pub fn videos(
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(EnhancedSeriesDetails::VT_VIDEOS, None)
        }
    }
    #[inline]
    pub fn keywords(
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(EnhancedSeriesDetails::VT_KEYWORDS, None)
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<ExternalIds>>(
                    EnhancedSeriesDetails::VT_EXTERNAL_IDS,
                    None,
                )
        }
    }
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                EnhancedSeriesDetails::VT_ALTERNATIVE_TITLES, None
            )
        }
    }
    #[inline]
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(EnhancedSeriesDetails::VT_TRANSLATIONS, None)
        }
    }
    #[inline]
    pub fn episode_groups(
        ...
        ::flatbuffers::Vector<
            'a,
            ::flatbuffers::ForwardsUOffset<EpisodeGroupMembership<'a>>,
        >,
    > {
        // Safety:
        // Created from valid Table for this object
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<EpisodeGroupMembership>,
                >,
            >>(
                EnhancedSeriesDetails::VT_EPISODE_GROUPS, None
            )
        }
    }
    #[inline]
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                EnhancedSeriesDetails::VT_RECOMMENDATIONS, None
            )
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    ...
                    ::flatbuffers::ForwardsUOffset<RelatedMediaRef>,
                >,
            >>(EnhancedSeriesDetails::VT_SIMILAR, None)
        }
    }
}
...
impl ::flatbuffers::Verifiable for EnhancedSeriesDetails<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                "first_air_date",
                Self::VT_FIRST_AIR_DATE,
                false,
            )?
            .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                "last_air_date",
                Self::VT_LAST_AIR_DATE,
                false,
            )?
            .visit_field::<u16>(
                "number_of_seasons",
                Self::VT_NUMBER_OF_SEASONS,
                false,
            )?
            .visit_field::<u16>(
                "number_of_episodes",
                Self::VT_NUMBER_OF_EPISODES,
                false,
            )?
            .visit_field::<u16>(
                "available_seasons",
                Self::VT_AVAILABLE_SEASONS,
                false,
            )?
            .visit_field::<u16>(
                "available_episodes",
                Self::VT_AVAILABLE_EPISODES,
                false,
            )?
            ...
            .visit_field::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    ...
                    ::flatbuffers::ForwardsUOffset<NetworkInfo>,
                >,
            >>("networks", Self::VT_NETWORKS, false)?
            .visit_field::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    '_,
                    ::flatbuffers::ForwardsUOffset<&'_ str>,
                >,
            >>("origin_countries", Self::VT_ORIGIN_COUNTRIES, false)?
            .visit_field::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    '_,
                    ::flatbuffers::ForwardsUOffset<SpokenLanguage>,
            ...
            .visit_field::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    ...
                    ::flatbuffers::ForwardsUOffset<EpisodeGroupMembership>,
                >,
            >>("episode_groups", Self::VT_EPISODE_GROUPS, false)?
            .visit_field::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    '_,
                    ::flatbuffers::ForwardsUOffset<RelatedMediaRef>,
...
pub struct EnhancedSeriesDetailsBuilder<
    'a: 'b,
    'b,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a>
    EnhancedSeriesDetailsBuilder<'a, 'b, A>
{
    #[inline]
    pub fn add_id(&mut self, id: u64) {
        self.fbb_
            .push_slot::<u64>(EnhancedSeriesDetails::VT_ID, id, 0);
    }
    #[inline]
    ...
    #[inline]
    pub fn add_first_air_date(
        &mut self,
        first_air_date: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_FIRST_AIR_DATE,
            first_air_date,
    ...
    #[inline]
    pub fn add_last_air_date(
        &mut self,
        last_air_date: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_LAST_AIR_DATE,
            last_air_date,
    ...
    pub fn add_vote_average(&mut self, vote_average: f32) {
        self.fbb_.push_slot::<f32>(
            EnhancedSeriesDetails::VT_VOTE_AVERAGE,
            vote_average,
            0.0,
        );
    }
    ...
    pub fn add_vote_count(&mut self, vote_count: u32) {
        self.fbb_.push_slot::<u32>(
            EnhancedSeriesDetails::VT_VOTE_COUNT,
            vote_count,
            0,
        );
    }
    ...
    pub fn add_popularity(&mut self, popularity: f32) {
        self.fbb_.push_slot::<f32>(
            EnhancedSeriesDetails::VT_POPULARITY,
            popularity,
            0.0,
        );
    }
    ...
    pub fn add_content_ratings(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_CONTENT_RATINGS,
            content_ratings,
        );
    }
    #[inline]
    pub fn add_release_dates(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_RELEASE_DATES,
            release_dates,
        );
    }
    #[inline]
    pub fn add_genres(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_GENRES,
            genres,
        );
    }
    #[inline]
    pub fn add_networks(
        &mut self,
        networks: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<NetworkInfo<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_NETWORKS,
            networks,
        );
    }
    #[inline]
    pub fn add_origin_countries(
        &mut self,
        origin_countries: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<&'b str>>,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_ORIGIN_COUNTRIES,
            origin_countries,
        );
    }
    #[inline]
    pub fn add_spoken_languages(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_SPOKEN_LANGUAGES,
            spoken_languages,
        );
    }
    #[inline]
    pub fn add_production_companies(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_PRODUCTION_COMPANIES,
    ...
    pub fn add_production_countries(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_PRODUCTION_COUNTRIES,
    ...
    pub fn add_videos(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_VIDEOS,
            videos,
        );
    }
    #[inline]
    pub fn add_keywords(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_KEYWORDS,
            keywords,
        );
    }
    #[inline]
    ...
    pub fn add_alternative_titles(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_ALTERNATIVE_TITLES,
            alternative_titles,
        );
    }
    #[inline]
    pub fn add_translations(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_TRANSLATIONS,
            translations,
        );
    }
    #[inline]
    pub fn add_episode_groups(
        &mut self,
        episode_groups: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<EpisodeGroupMembership<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_EPISODE_GROUPS,
            episode_groups,
        );
    }
    #[inline]
    pub fn add_recommendations(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_RECOMMENDATIONS,
            recommendations,
        );
    }
    #[inline]
    pub fn add_similar(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            EnhancedSeriesDetails::VT_SIMILAR,
            similar,
        );
    }
    #[inline]
