...
use crate::conversions::details::{
    ...
    build_season_details, build_episode_details,
};
...
pub fn build_season_reference<'a>(
    ...
    fb::SeasonReference::create(builder, &fb::SeasonReferenceArgs {
        id: Some(&id),
        library_id: Some(&library_id),
...
pub fn build_episode_reference<'a>(
    ...
    fb::EpisodeReference::create(builder, &fb::EpisodeReferenceArgs {
        id: Some(&id),
        library_id: Some(&library_id),
