...
use objc2_foundation::{
    ns_string, CGFloat, MainThreadMarker, NSArray, NSCopying, NSDictionary,
...
pub(crate) struct State {
    ...
    /// Retain the view directly so raw-handle and renderer-surface recovery
    /// remains valid while AppKit installs it in a foreign host window.
...
declare_class!(
    ...
    unsafe impl NSWindowDelegate for WindowDelegate {
        ...
        fn window_will_close(&self, _: Option<&AnyObject>) {
            ...
            self.view().prepare_for_donor_close();
        ...
        fn window_did_change_backing_properties(&self, _: Option<&AnyObject>) {
            ...
            RunLoop::main(mtm).queue_closure(move || {
                view.handle_scale_factor_changed(false);
            });
        }
        ...
        fn window_did_change_occlusion_state(&self, _: Option<&AnyObject>) {
            ...
            if !view.is_foreign_hosted() {
                let visible =
                    self.window().occlusionState().contains(NSWindowOcclusionState::Visible);
                view.set_occluded(!visible);
            }
        }
...
) -> Option<(Retained<WinitWindow>, Retained<WinitView>)> {
    autoreleasepool(|_| {
...
impl WindowDelegate {
    pub(super) fn new(
        ...
        if scale_factor != 1.0 {
            ...
            RunLoop::main(mtm).queue_closure(move || {
                view.handle_scale_factor_changed(true);
            });
        }
        ...
        delegate.view().set_focused(false);
    ...
    #[track_caller]
    fn host_window(&self) -> Retained<NSWindow> {
        self.view().host_window()
    }
    ...
    pub fn is_visible(&self) -> Option<bool> {
        let view = self.view();
        if view.is_foreign_hosted() {
            Some(self.host_window().isVisible() && !unsafe { view.isHidden() })
        } else {
    ...
    pub fn outer_position(
        ...
        let position =
            flip_window_screen_coordinates(self.host_window().frame());
    ...
    pub fn inner_position(
        ...
        let screen_rect = self.host_window().convertRectToScreen(window_rect);
    ...
    pub fn inner_size(&self) -> PhysicalSize<u32> {
        ...
        let logical = LogicalSize::new(bounds.size.width, bounds.size.height);
        logical.to_physical(self.scale_factor())
    }

    #[inline]
    pub fn outer_size(&self) -> PhysicalSize<u32> {
        let frame = self.host_window().frame();
    ...
    pub fn set_cursor(&self, cursor: Cursor) {
        ...
        self.host_window().invalidateCursorRectsForView(&view);
    }
    ...
    pub fn scale_factor(&self) -> f64 {
        self.host_window().backingScaleFactor() as _
    }
    ...
    pub fn drag_window(&self) -> Result<(), ExternalError> {
        ...
        self.host_window().performWindowDragWithEvent(&event);
        Ok(())
    }
    ...
    pub fn set_cursor_hittest(
        ...
        let view = self.view();
        view.set_cursor_hittest(hittest);
        if !view.is_foreign_hosted() {
    ...
    pub fn is_minimized(&self) -> Option<bool> {
        Some(self.host_window().isMiniaturized())
    }
    ...
    pub(crate) fn fullscreen(&self) -> Option<Fullscreen> {
        ...
        {
            return Some(Fullscreen::Borderless(self.current_monitor_inner()));
        }
    ...
    pub fn is_decorated(&self) -> bool {
        if self.view().is_foreign_hosted() {
            self.host_window()
                .styleMask()
                .contains(NSWindowStyleMask::Titled)
        } else {
    ...
    pub fn focus_window(&self) {
        ...
        if view.is_foreign_hosted() {
            ...
            if !host.isMiniaturized() && host.isVisible() {
                host.makeFirstResponder(Some(&view));
            }
            return;
        }
    ...
    pub(crate) fn current_monitor_inner(&self) -> Option<MonitorHandle> {
        let display_id = get_display_id(&*self.host_window().screen()?);
    ...
    pub fn raw_window_handle_rwh_04(&self) -> rwh_04::RawWindowHandle {
        ...
        let host = self.host_window();
        window_handle.ns_window = Retained::as_ptr(&host) as *mut _;
    ...
    pub fn has_focus(&self) -> bool {
        self.host_window().isKeyWindow()
    }

    pub fn theme(&self) -> Option<Theme> {
        unsafe { self.host_window().appearance() }
    ...
    pub fn title(&self) -> String {
        self.host_window().title().to_string()
    }
