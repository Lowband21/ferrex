# Playback auth regression QA (LOW-415)
...
| Android full assemble/unit/lint | Not rerun for LOW-415 | No Android source code changed in this packet. The most recent full Android evidence is recorded in `mobile/android/docs/final-qa-acceptance-packet.md`; rerun the full Gradle gate if Android code changes. |
...
- `docs/playback-auth-regression-qa.md` — this cross-platform QA evidence packet.
...
- `mobile/android/docs/final-qa-acceptance-packet.md`
- `mobile/android/docs/playback-qa-matrix.md`
- `mobile/android/docs/tv-10ft-qa-matrix.md`
