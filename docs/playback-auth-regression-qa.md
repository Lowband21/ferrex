# Moved: Playback auth regression QA
...
- Public docs: <https://ferrexmedia.org/reference/qa/playback-auth-regression/>
- Source page: `docs/src/content/docs/reference/qa/playback-auth-regression.md`
