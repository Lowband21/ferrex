# Moved: Player dependency boundaries
...
- Public docs: <https://ferrexmedia.org/developer/player-dependency-boundaries/>
- Source page: `docs/src/content/docs/developer/player-dependency-boundaries.md`
