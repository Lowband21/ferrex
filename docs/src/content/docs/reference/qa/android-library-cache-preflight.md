---
title: "Android library cache preflight"
description: "LOW-344 recovery-first Android library-cache preflight notes and no-wipe reset expectations."
sidebar:
  order: 4
---
...
LOW-345 extends this preflight for image manifest metadata and Coil blobs in [Android image pipeline preflight](/reference/qa/android-image-pipeline-preflight/).
