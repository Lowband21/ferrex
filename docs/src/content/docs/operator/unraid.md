---
title: "Unraid deployment notes"
description: "Compose-first guidance for running Ferrex on Unraid with recommended appdata paths, permissions, and performance overlay notes."
sidebar:
  order: 4
---
