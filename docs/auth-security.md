# Moved: Authentication security model
...
- Public docs: <https://ferrexmedia.org/operator/auth-security/>
- Source page: `docs/src/content/docs/operator/auth-security.md`
