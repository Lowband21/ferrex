...
/// });
/// ```
pub fn spawn_profiled<F>(name: impl Into<String> + Send + 'static, future: F) -> tokio::task::JoinHandle<F::Output>
where
...
mod tests {
    ...
    async fn test_manual_scope() {
        ...
        let async_result = scope.profile_async(async {
