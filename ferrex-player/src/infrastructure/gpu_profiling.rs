...
impl GpuProfiler {
    ...
    pub fn new(device: &wgpu::Device, queue: &wgpu::Queue) -> Self {
        ...
        #[cfg(feature = "profile-with-tracy")]
        {
            ...
            log::info!(
                "Tracy GPU context created with initial timestamp: {}",
                initial_timestamp
            );
    ...
    pub fn upload_timestamps(&mut self, device: &wgpu::Device) {
        ...
        if receiver.recv().unwrap().is_ok() {
            ...
            for i in 0..self.next_query_index {
                ...
                let timestamp =
                    u64::from_le_bytes(data[offset..offset + 8].try_into().unwrap()) as i64;
