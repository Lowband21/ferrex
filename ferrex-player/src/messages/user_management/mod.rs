...
impl Message {
    ...
    pub fn sanitized_display(&self) -> String {
        match self {
            ...
            Self::CreateUserFormUpdatePassword(_) => "CreateUserFormUpdatePassword(***)".to_string(),
            Self::CreateUserFormUpdateConfirmPassword(_) => "CreateUserFormUpdateConfirmPassword(***)".to_string(),
            Self::UpdateUserFormUpdatePassword(_) => "UpdateUserFormUpdatePassword(***)".to_string(),
            Self::UpdateUserFormUpdateConfirmPassword(_) => "UpdateUserFormUpdateConfirmPassword(***)".to_string(),
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Self::CreateUserFormUpdateDisplayName(_) => "UserManagement::CreateUserFormUpdateDisplayName",
            Self::CreateUserFormUpdatePassword(_) => "UserManagement::CreateUserFormUpdatePassword",
            Self::CreateUserFormUpdateConfirmPassword(_) => "UserManagement::CreateUserFormUpdateConfirmPassword",
            Self::CreateUserFormTogglePasswordVisibility => "UserManagement::CreateUserFormTogglePasswordVisibility",
            ...
            Self::UpdateUserFormUpdateDisplayName(_) => "UserManagement::UpdateUserFormUpdateDisplayName",
            Self::UpdateUserFormUpdatePassword(_) => "UserManagement::UpdateUserFormUpdatePassword",
            Self::UpdateUserFormUpdateConfirmPassword(_) => "UserManagement::UpdateUserFormUpdateConfirmPassword",
            Self::UpdateUserFormTogglePasswordVisibility => "UserManagement::UpdateUserFormTogglePasswordVisibility",
            ...
            Self::FirstRunUpdateConfirmPassword(_) => "UserManagement::FirstRunUpdateConfirmPassword",
            Self::FirstRunTogglePasswordVisibility => "UserManagement::FirstRunTogglePasswordVisibility",
            ...
            // Internal
            Self::_EmitCrossDomainEvent(_) => "UserManagement::_EmitCrossDomainEvent",
        }
    }
}
