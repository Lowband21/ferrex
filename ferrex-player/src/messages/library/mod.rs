...
pub enum Message {
    ...
    LibraryLoaded(Result<Vec<crate::media_library::MediaFile>, String>),
    ...
    LibrarySelected(Uuid, Result<Vec<crate::media_library::MediaFile>, String>),
    ScanLibrary_(Uuid),
    ...
    AllLibrariesLoaded(Vec<(Uuid, Result<LibraryMediaResponse, String>)>),
    ...
    MediaDiscovered(Vec<crate::api_types::MediaReference>),
    MediaUpdated(crate::api_types::MediaReference),
    ...
    MediaDetailsBatch(Vec<crate::api_types::MediaReference>),
...
impl Message {
    pub fn name(&self) -> &'static str {
        match self {
            // Core library loading
            Self::LibraryLoaded(_) => "Library::LibraryLoaded",
            Self::MoviesLoaded(_) => "Library::MoviesLoaded",
            ...
            Self::ScanLibrary_(_) => "Library::ScanLibrary_",
            ...
            // Scanning
            Self::ScanLibrary => "Library::ScanLibrary",
            ...
            Self::AllLibrariesLoaded(_) => "Library::AllLibrariesLoaded",
            ...
            // Library aggregation
            Self::AggregateAllLibraries => "Library::AggregateAllLibraries",
            ...
            // Internal
            Self::_EmitCrossDomainEvent(_) => "Library::_EmitCrossDomainEvent",
...
impl std::fmt::Debug for Message {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            // Core library loading
            Self::LibraryLoaded(result) => match result {
                Ok(files) => write!(f, "Library::LibraryLoaded(Ok: {} files)", files.len()),
                Err(e) => write!(f, "Library::LibraryLoaded(Err: {})", e),
            },
            Self::MoviesLoaded(result) => match result {
                Ok(movies) => write!(f, "Library::MoviesLoaded(Ok: {} movies)", movies.len()),
                Err(e) => write!(f, "Library::MoviesLoaded(Err: {})", e),
            },
            ...
            Self::ScanLibrary_(id) => write!(f, "Library::ScanLibrary_({})", id),
            ...
            // Scanning
            Self::ScanLibrary => write!(f, "Library::ScanLibrary"),
            ...
            Self::AllLibrariesLoaded(results) => {
                write!(f, "Library::AllLibrariesLoaded({} results)", results.len())
            }
            ...
            // Library aggregation
            Self::AggregateAllLibraries => write!(f, "Library::AggregateAllLibraries"),
            ...
            Self::_EmitCrossDomainEvent(event) => {
                write!(f, "Library::_EmitCrossDomainEvent({:?})", event)
            }
...
pub enum LibraryEvent {
    ...
    MediaDiscovered(Vec<crate::media_library::MediaFile>),
}
