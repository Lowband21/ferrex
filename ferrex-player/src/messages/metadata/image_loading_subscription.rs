                    ...
                    ImageLoaderState::Running {
                        ...
                        if batch.len() >= BATCH_SIZE || (!batch.is_empty() && !received_new) {
                            ...
                            if let Some(image_service) =
                                crate::service_registry::get_image_service()
                            {
                            ...
                            let category = match request.size {
                                crate::image_types::ImageSize::Poster => "poster",
                                crate::image_types::ImageSize::Backdrop => "backdrop",
                                crate::image_types::ImageSize::Thumbnail => {
                                ...
                                crate::image_types::ImageSize::Full => "poster", // Use poster for full size too
                                crate::image_types::ImageSize::Profile => "profile", // Person profile images
                            };
                            ...
                            let size_param = match request.size {
                                crate::image_types::ImageSize::Backdrop => "?size=original", // Original quality backdrop
                                crate::image_types::ImageSize::Thumbnail => "?size=w185", // Small thumbnail
                                crate::image_types::ImageSize::Poster => "?size=w500", // Medium poster
                                crate::image_types::ImageSize::Full => "?size=original", // Original size
                                crate::image_types::ImageSize::Profile => "?size=w185", // Profile size
                            };
