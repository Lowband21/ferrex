...
pub mod scrolling {
    ...
    pub const KINETIC_TICK_NS: u64 = 8_333_333;
    ...
    pub const KINETIC_ACCEL_TAU_MS: u64 = 0;
    ...
    pub const KINETIC_ACCEL_TAU_TO_RAMP_RATIO: f32 = 0.4; // Default: 0.4
    ...
    pub const KINETIC_DECAY_TAU_MS: u64 = 240;
    ...
    pub const KINETIC_BASE_ROWS_PER_S: f32 = 0.5;
    ...
    pub const KINETIC_MAX_ROWS_PER_S: f32 = 5.0;
    ...
    pub const KINETIC_MIN_ROWS_PER_S_STOP: f32 = 0.08;
    ...
    pub const KINETIC_BOOST_MULTIPLIER: f32 = 4.0;
}
