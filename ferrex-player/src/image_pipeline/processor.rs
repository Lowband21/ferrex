...
fn process_image_sync(data: &[u8], options: ProcessOptions) -> Result<ProcessedImage> {
    ...
    let (target_width, target_height) = match options.size {
        crate::image_types::ImageSize::Thumbnail => (150, 225),
        crate::image_types::ImageSize::Poster => (300, 450),
        crate::image_types::ImageSize::Backdrop => (800, 450),
        crate::image_types::ImageSize::Full => (600, 900),
        crate::image_types::ImageSize::Profile => (120, 180), // 2:3 aspect ratio for cast
    };
