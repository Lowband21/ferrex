...
impl ThemeColorAccess for crate::api_types::MovieReference {
    fn theme_color(&self) -> Option<&str> {
        self.theme_color.as_deref()
    }
}

impl ThemeColorAccess for crate::api_types::SeriesReference {
    fn theme_color(&self) -> Option<&str> {
        self.theme_color.as_deref()
    }
}

impl ThemeColorAccess for crate::api_types::SeasonReference {
    fn theme_color(&self) -> Option<&str> {
        self.theme_color.as_deref()
    }
}
...
impl ThemeColorAccess for crate::api_types::EpisodeReference {
    fn theme_color(&self) -> Option<&str> {
        None
    }
}
...
macro_rules! media_card {
    (
        ...
        use $crate::views::cards::types::*;
        use $crate::widgets::{AnimationType as WidgetAnimationType};
        use $crate::theme;
        use iced::{
        ...
        let image_element: Element<'_, $crate::messages::ui::Message> = {
            use $crate::widgets::image_for;

            // Determine image size based on card size
            let image_size = match card_size {
                CardSize::Small => $crate::image_types::ImageSize::Thumbnail,
                CardSize::Medium => $crate::image_types::ImageSize::Poster,
                CardSize::Large => $crate::image_types::ImageSize::Full,
                CardSize::Wide => $crate::image_types::ImageSize::Backdrop,
                CardSize::Custom(_, _) => $crate::image_types::ImageSize::Poster,
            };

            //// Map priority if provided
            let priority = $crate::image_types::Priority::Preload;
            ...
            use $crate::views::macros::ThemeColorAccess;
        ...
        let image_with_hover = iced::widget::mouse_area(image_element)
            .on_enter($crate::messages::ui::Message::MediaHovered($image_key.to_string()))
            .on_exit($crate::messages::ui::Message::MediaUnhovered($image_key.to_string()));
        ...
        let poster_with_overlay_element = if matches!(widget_anim, WidgetAnimationType::EnhancedFlip { .. }) {
            ...
            let centered_poster: Element<'_, $crate::messages::ui::Message> = container(poster_element)
        ...
        let truncated_title = $crate::views::macros::truncate_text($title, title_max_chars);
        let truncated_subtitle = $crate::views::macros::truncate_text($subtitle, subtitle_max_chars);
