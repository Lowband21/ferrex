...
macro_rules! virtual_reference_grid {
    (
        ...
        pub fn $name<'a>(
            items: &'a [$item_type],
            grid_state: &$crate::views::grid::virtual_list::VirtualGridState,
            hovered_media_id: &Option<String>,
            on_scroll: impl Fn(iced::widget::scrollable::Viewport) -> $crate::messages::ui::Message + 'a,
            fast_scrolling: bool,
            state: &'a $crate::State,
        ) -> iced::Element<'a, $crate::messages::ui::Message> {
            use iced::{
            ...
            use $crate::constants::{grid, poster};
                ...
                for col in 0..grid_state.columns {
                    ...
                    if item_idx < items.len() && item_idx < grid_state.visible_range.end {
                        ...
                        let (container_width, container_height) =
                            $crate::constants::calculations::get_container_dimensions(1.0);
                        ...
                        let total_card_height = poster::TOTAL_CARD_HEIGHT
                            + 2.0 * $crate::constants::animation::calculate_vertical_padding(poster::BASE_HEIGHT);
                        ...
                        row_content = row_content.push(
                            ...
                            .style($crate::theme::Container::Default.style()),
                        );
                    }
                }
            ...
            .width(Length::Fill)
            .height(Length::Fill)
            .style($crate::theme::Scrollable::style());
