...
impl ScrollState {
    ...
    pub fn from_grid_state(grid_state: &VirtualGridState) -> Self {
        Self {
            ...
            visible_range: Some((grid_state.visible_range.start, grid_state.visible_range.end)),
        }
    }
}
...
impl ScrollPositionManager {
    ...
    fn tab_scroll_key(tab_id: &crate::domains::ui::tabs::TabId) -> String {
        match tab_id {
            crate::domains::ui::tabs::TabId::All => "tab.all".to_string(),
...
impl ScrollStateExt for crate::state_refactored::State {
    ...
    fn save_current_view_scroll(&mut self, state: ScrollState) {
        ...
        let library_id = self.domains.library.state.current_library_id;
