...
pub mod responsive {
    ...
    pub fn calculate_columns(window_width: f32, card_width: f32, padding: f32) -> usize {
        ...
        crate::infrastructure::constants::calculations::calculate_columns(window_width, 1.0)
    }
    ...
    pub fn calculate_grid_padding(window_width: f32, columns: usize, card_width: f32) -> f32 {
        // Delegate to centralized calculation
        crate::infrastructure::constants::calculations::calculate_grid_padding(
            window_width,
            columns,
            1.0,
        )
    ...
    pub fn adaptive_card_size(window_width: f32) -> super::types::CardSize {
        use super::super::types::CardSize;
