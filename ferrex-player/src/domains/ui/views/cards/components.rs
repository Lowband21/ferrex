...
pub fn position_badge(
    ...
    position: types::BadgePosition,
    card_width: f32,
    card_height: f32,
) -> Element<'static, Message> {
    use types::BadgePosition;
...
pub fn entrance_animation(
    ...
    use types::{AnimationType, Direction};
...
pub fn media_type_indicator(media_type: types::MediaType) -> Element<'static, Message> {
    let icon = media_type.hover_icon();
    let color = match media_type {
        types::MediaType::Movie => Color::from_rgb(1.0, 0.5, 0.0),
        types::MediaType::Series => Color::from_rgb(0.0, 0.7, 1.0),
        types::MediaType::Season => Color::from_rgb(0.0, 0.7, 1.0),
        types::MediaType::Episode => Color::from_rgb(0.5, 0.5, 1.0),
    };
