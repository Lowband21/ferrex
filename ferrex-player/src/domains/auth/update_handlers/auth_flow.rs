...
pub fn transition_to_auto_login_check(state: &mut State) -> Task<auth::Message> {
    use crate::domains::auth::types::AuthenticationFlow;
...
pub fn handle_show_pin_entry(_state: &mut State, _user: core::User) -> Task<auth::Message> {
