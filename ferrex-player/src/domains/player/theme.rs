...
pub fn container_gradient_bottom(_theme: &iced::Theme) -> container::Style {
    container::Style {
        background: Some(Background::Gradient(
            iced::gradient::Linear::new(iced::Radians(3.0 * std::f32::consts::PI / 2.0))
                .add_stop(0.0, Color::from_rgba(0.0, 0.0, 0.0, 0.8))
                .add_stop(1.0, Color::from_rgba(0.0, 0.0, 0.0, 0.0))
                .into(),
        )),
...
pub fn container_settings_panel_wrapper(_theme: &iced::Theme) -> container::Style {
...
pub fn container_subtitle_menu_wrapper(_theme: &iced::Theme) -> container::Style {
    container::Style::default()
}
...
// Button styles
pub fn button_player(_theme: &iced::Theme, status: button::Status) -> button::Style {
    match status {
...
pub fn button_player_active(_theme: &iced::Theme, status: button::Status) -> button::Style {
    match status {
        button::Status::Active => button::Style {
            background: Some(Background::Color(Color::from_rgba(0.0, 0.5, 1.0, 0.01))),
...
pub fn button_player_disabled(_theme: &iced::Theme, _status: button::Status) -> button::Style {
    button::Style {
...
pub fn button_transparent(_theme: &iced::Theme, status: button::Status) -> button::Style {
    button::Style {
        background: None,
...
pub fn button_menu_item(_theme: &iced::Theme, status: button::Status) -> button::Style {
    match status {
        button::Status::Active => button::Style {
            background: Some(Background::Color(Color::TRANSPARENT)),
        ...
        button::Status::Hovered => button::Style {
            background: Some(Background::Color(Color::from_rgba(0.0, 0.5, 1.0, 0.2))),
            text_color: Color::WHITE,
            border: Border::default(),
            ..Default::default()
        },
        button::Status::Pressed => button::Style {
            background: Some(Background::Color(Color::from_rgba(0.0, 0.5, 1.0, 0.3))),
            text_color: Color::WHITE,
            border: Border::default(),
            ..Default::default()
        },
...
pub fn button_seek_bar(_theme: &iced::Theme, _status: button::Status) -> button::Style {
    button::Style {
        background: Some(Background::Color(Color::TRANSPARENT)),
...
// Slider styles
pub fn slider_seek(_theme: &iced::Theme, status: slider::Status) -> slider::Style {
...
pub fn slider_seek_invisible(_theme: &iced::Theme, _status: slider::Status) -> slider::Style {
    slider::Style {
        rail: slider::Rail {
            backgrounds: (
...
pub fn slider_volume(_theme: &iced::Theme, status: slider::Status) -> slider::Style {
    let handle_color = match status {
...
pub fn button_glassy(_theme: &iced::Theme, _status: button::Status) -> button::Style {
    button::Style {
...
pub fn button_active_setting(_theme: &iced::Theme, _status: button::Status) -> button::Style {
    button::Style {
        background: Some(Background::Color(Color::from_rgba(1.0, 1.0, 1.0, 0.2))),
        border: Border {
            color: Color::from_rgba(1.0, 1.0, 1.0, 0.3),
...
// Pick list style
pub fn pick_list_dark<T>(_theme: &iced::Theme, _status: pick_list::Status) -> pick_list::Style {
    pick_list::Style {
        text_color: Color::WHITE,
...
// Toggler style
pub fn toggler_dark(_theme: &iced::Theme, status: toggler::Status) -> toggler::Style {
