...
use crate::domain::users::auth::domain::value_objects::{
    DeviceFingerprint, RevocationReason,
};
...
mod tests {
    ...
    use crate::domain::users::auth::domain::value_objects::RevocationReason;
    use crate::domain::users::auth::domain::value_objects::{
        DeviceFingerprint, SessionScope,
    };
    ...
    impl RefreshTokenRepository for RecordingRefreshRepo {
        async fn insert_refresh_token(
            ...
            _family_id: Uuid,
            _generation: i32,
            _origin_scope: crate::domain::users::auth::domain::value_objects::SessionScope,
        ) -> anyhow::Result<Uuid> {
            Ok(Uuid::now_v7())
        }
