...
impl CostEstimator {
    ...
    pub fn estimate_server_cost(
        ...
        let server_cost = self.base_costs.server_query_base_ms * match query_complexity {
        ...
        let transfer_cost = (estimated_response_size_kb as f32 * self.base_costs.transfer_per_kb_ms) as u64;
        ...
        let historical_adjustment = if !metrics.server_query_times.is_empty() {
            ...
            let similar_times: Vec<u64> = metrics.server_query_times
                .iter()
