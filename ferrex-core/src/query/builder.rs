...
impl MediaQueryBuilder {
    ...
    /// Filter by library
    pub fn in_library(mut self, library_id: Uuid) -> Self {
        self.query.filters.library_ids.push(library_id);
        self
    }
...
impl MediaQuery {
    ...
    pub fn browse_library(library_id: Uuid, page: usize, per_page: usize) -> Self {
        MediaQueryBuilder::new()
